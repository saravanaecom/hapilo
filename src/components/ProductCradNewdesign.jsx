...
const ProductCardNewDesign = ({ get_fav_lists, product, isLoading, offerProducts, relatedProducts, newProducts }) => {
...
export default connect(mapStateToProps, null)(ProductCardNewDesign);
